<%@ Page Title="" Language="C#" MasterPageFile="~/Users.Master" AutoEventWireup="true" CodeBehind="Seafood.aspx.cs" Inherits="Projet_AppTrans.Customers.Seafood" %>

<asp:Content ID="Content1" ContentPlaceHolderID="UserContent" runat="server">
    <%--<h1 class="mt-3">
        <center>Seafood</center>
    </h1>--%>
