...
namespace Projet_AppTrans
{
    public partial class Vegetables : System.Web.UI.Page
    {
        ...
        private void BindProductData()
        {
            ...
            {
                using (SqlDataAdapter sda = new SqlDataAdapter("SELECT id, name, description, price, image_path, quantity FROM products WHERE category_id = 1;", con))
                {
        ...
        protected void AddToCart(object sender, EventArgs e)
        {
            ...
            if(productQty > 0 && !cart.Any(p => p.id == productId))
            {
                ...
                cart.Add(product);
                message_id.Text = "Product added successfully";
        ...
        protected void Find(object sender, EventArgs e)
        {
            ...
            else if (dt.Rows.Count == 0)
            {
                ...
                search_error.Font.Size = FontUnit.Point(20);
                search_error.Font.Bold= true;
