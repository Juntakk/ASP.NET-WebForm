<%@ Page Title="" Language="C#" MasterPageFile="~/Users.Master" AutoEventWireup="true" CodeBehind="Desserts.aspx.cs" Inherits="Projet_AppTrans.Customers.Desserts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="UserContent" runat="server">
    <%--<h1 class="mt-3"><center>Desserts</center></h1>--%>
